-- Seed all 70 Java Stream API problems
...
-- Due to size constraints, I've provided a script approach below
-- Please see the instructions in README-DATABASE.md for the complete seeding process
